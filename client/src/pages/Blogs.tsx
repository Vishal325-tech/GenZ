...
const BLOGS = [
  {
    ...
    content: 'Luxury is in the details. At GenZ, we believe that wrapping is an art form. When you send a gift box wrapped in silk mesh or rich velvet, the opening experience is just as memorable as the contents itself...',
